...
"""This module contains functions to generate SVNCommits."""
...
def _pre_commit(cvs_revs, done_symbols):
  ...
  DONE_SYMBOLS is a set of symbols for which the last source revision
  has already been seen and for which the CVSRevisionCreator has
  already generated a fill SVNCommit.  See process_revisions()."""
