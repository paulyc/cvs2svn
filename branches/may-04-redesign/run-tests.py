...
def default_branches():
  ...
  check_rev(logs, 17, sym_log_msg('vtag-4',1), {
    '/tags/vtag-4 (from /branches/vbranchA:15)' : 'A',
    '/tags/vtag-4/proj/d.txt '
    '(from /branches/unlabeled-1.1.1/proj/d.txt:15)' : 'A',
    })

  check_rev(logs, 5, sym_log_msg('vtag-1',1), {
    '/tags/vtag-1 (from /branches/vbranchA:4)' : 'A',
    '/tags/vtag-1/proj/d.txt '
    '(from /branches/unlabeled-1.1.1/proj/d.txt:4)' : 'A',
    })

  check_rev(logs, 8, sym_log_msg('vtag-2',1), {
    '/tags/vtag-2 (from /branches/vbranchA:6)' : 'A',
    '/tags/vtag-2/proj/d.txt '
    '(from /branches/unlabeled-1.1.1/proj/d.txt:6)' : 'A',
    })

  check_rev(logs, 11, sym_log_msg('vtag-3',1), {
    '/tags/vtag-3 (from /branches/vbranchA:9)' : 'A',
    '/tags/vtag-3/proj/d.txt '
    '(from /branches/unlabeled-1.1.1/proj/d.txt:9)' : 'A',
    '/tags/vtag-3/proj/e.txt '
    '(from /branches/unlabeled-1.1.1/proj/e.txt:9)' : 'A',
    })

  check_rev(logs, 16, "This commit was generated by cvs2svn "
                       "to compensate for changes in r15,", {
    '/trunk/proj/b.txt (from /branches/vbranchA/proj/b.txt:15)' : 'R',
    '/trunk/proj/c.txt (from /branches/vbranchA/proj/c.txt:15)' : 'R',
    '/trunk/proj/d.txt (from /branches/unlabeled-1.1.1/proj/d.txt:15)' : 'R',
    '/trunk/proj/deleted-on-vendor-branch.txt '
    '(from /branches/vbranchA/proj/deleted-on-vendor-branch.txt:15)' : 'A',
    '/trunk/proj/e.txt (from /branches/unlabeled-1.1.1/proj/e.txt:15)' : 'R',
    })

  check_rev(logs, 15, "Import (vbranchA, vtag-4).", {
  ...
  check_rev(logs, 14, sym_log_msg('vbranchA'), {
    '/branches/vbranchA/proj/added-then-imported.txt '
    '(from /trunk/proj/added-then-imported.txt:13)' : 'A',
    })

  check_rev(logs, 13, "Add a file to the working copy.", {
    '/trunk/proj/added-then-imported.txt' : 'A',
    })

  check_rev(logs, 12, "First regular commit, to a.txt, on vtag-3.", {
    '/trunk/proj/a.txt' : 'M',
    })

  check_rev(logs, 10, "This commit was generated by cvs2svn "
                      "to compensate for changes in r9,", {
    '/trunk/proj/a.txt (from /branches/vbranchA/proj/a.txt:9)' : 'R',
  ...
  check_rev(logs, 9, "Import (vbranchA, vtag-3).", {
    '/branches/unlabeled-1.1.1/proj/d.txt' : 'M',
    '/branches/unlabeled-1.1.1/proj/e.txt' : 'M',
    '/branches/vbranchA/proj/a.txt' : 'M',
    '/branches/vbranchA/proj/b.txt' : 'M',
  ...
  check_rev(logs, 7, "This commit was generated by cvs2svn "
                      "to compensate for changes in r6,", {
    '/trunk/proj/a.txt (from /branches/vbranchA/proj/a.txt:6)' : 'R',
    '/trunk/proj/b.txt (from /branches/vbranchA/proj/b.txt:6)' : 'R',
    '/trunk/proj/c.txt (from /branches/vbranchA/proj/c.txt:6)' : 'R',
    '/trunk/proj/d.txt (from /branches/unlabeled-1.1.1/proj/d.txt:6)' : 'R',
    '/trunk/proj/deleted-on-vendor-branch.txt '
    '(from /branches/vbranchA/proj/deleted-on-vendor-branch.txt:6)' : 'R',
    '/trunk/proj/e.txt (from /branches/unlabeled-1.1.1/proj/e.txt:6)' : 'R',
    })

  check_rev(logs, 6, "Import (vbranchA, vtag-2).", {
    '/branches/unlabeled-1.1.1/proj/d.txt' : 'M',
    '/branches/unlabeled-1.1.1/proj/e.txt' : 'M',
    '/branches/vbranchA/proj/a.txt' : 'M',
    '/branches/vbranchA/proj/b.txt' : 'M',
